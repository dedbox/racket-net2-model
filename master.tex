...
state. A listener references a connection request queue. A transport
references its endpoints and ports.
...
\GlossaryItem{byte stream}{A uni-directional communications channel.}

\GlossaryItem{connection}{A bi-directional communications channel.}
